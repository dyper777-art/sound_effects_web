...
from .models import SubscriptionPlan, Product, Subscription, DownloadLog
...
# Custom filter for active/expired subscriptions
...
class CustomUserAdmin(BaseUserAdmin):
    ...
    inlines = [SubscriptionInline, DownloadLogInline]
